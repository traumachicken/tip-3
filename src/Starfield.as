/* アップデート毎にBitmapDataをRectangleで塗りつぶしてから星を描画
 * 星はピクセルごとに描画
 * 星のオブジェクト化せず、配列でパラメータを管理
 * 
 * 
 * 
 * 
...
package  
{
	...
	public class Starfield extends FlxSprite
	{
		...
		public function Starfield() 
		{
			...
			makeGraphic(640, 480, 0x44333333);
			
			fillRect = new Rectangle(0, 0, 640, 480);
			...
			starColours = new Array(0, 0, 0xffFF8888, 0xffaFFaaa, 0xffcccccc, 0xffdedede, 0xffF7F7F7);
		...
		override public function update():void
		{
			...
			//scratch = pixels;
			//
			//scratch.fillRect(fillRect, 0x11220000);
			//
